...
<div id="orgquery" class="develop" style="display:none;">
    <table>
        <tr>
            <td style="display:none;"><label>机构类型：</label></td>
            <td style="display:none;">
                <div id="itype" class="search-select" idField="value" textField="text" width="150" height="25"></div>
            </td>

            <td><label>是否部门：</label></td>
            <td>
                <div id="iisdepartment" class="search-select" idField="value" textField="text" width="150" height="25"></div>
            </td>
...
<script type="text/javascript" src="${JS}/orgs/OrgsMgrHandle.js?${V}"></script>
</body>
</html>