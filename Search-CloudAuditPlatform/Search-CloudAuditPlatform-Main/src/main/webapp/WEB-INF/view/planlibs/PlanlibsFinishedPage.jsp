...
<div class="mini-fit">
    <div id="planlibsGrid" class="search-treedatagrid" idField="sid" parentField="pid" textField="sname" showCheckBox="false" multiSelect="false"
        ...
        <div property="columns">
            ...
            <div field="currentusername" width="100" headAlign="center" textAlign="left">计划状态</div>
...
<script type="text/javascript" src="${JS}/planlibs/PlanlibsFinishedPage.js?${V}"></script>
</body>
</html>