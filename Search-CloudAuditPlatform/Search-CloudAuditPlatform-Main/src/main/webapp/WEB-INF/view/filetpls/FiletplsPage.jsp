...
<div class="mini-fit">
    <div id="filetplsgrid" class="search-datagrid" idField="sid" showCheckBox="true" multiSelect="true"
        ...
        <div property="columns">
            ...
            <div field="sdesc" width="300" headAlign="center" textAlign="right">描述</div>
...
<script type="text/javascript" language="javascript" src="${JS}/filetpls/FiletplsPage.js?v=${RES_VER}"></script>
</body>
</html>